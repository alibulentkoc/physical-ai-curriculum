...
_Last updated: 2026-06 — Module 5 (Inverse Kinematics) COMPLETE (32/32 lessons, Installments A–D; D-056). 5 of 10 modules done._
...
- **Lessons:** 133  (33 + 36 + 32 + 32)
- **Notebooks:** 133  (one per lesson; all execute clean)
- **SVGs:** 134  (M1 lesson 1 ships two; `assets/diagrams/`, mirrored to `site_src/assets/`)
- **Demos (interactive HTML):** 26  (12 + 6 + 4 + 4)
- **Quizzes (interactive HTML widgets):** 133  (one per lesson)
- **Answer keys:** 133 lesson keys in `coaches/answer-keys/` + midpoint keys (M1, M2, M4) and capstone rubrics
- **Assessments:** 4 midpoint assessments (`assessments/moduleNN_midpoint_assessment.md`) + M3 & M4 Unit-8 capstone mini-projects
- **Site:** `mkdocs build --strict` PASS — 165 built pages (133 M1–M4 lessons + 32 M5 lessons + index)

## In production

- *(none — Module 5 complete; Module 6 not yet started)*
