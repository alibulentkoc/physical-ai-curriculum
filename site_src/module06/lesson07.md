!!! abstract "You are here"
    **Module 6 — Jacobians and Differential Motion**  ·  **Unit 2 — Geometric Jacobian & Forward Velocity Kinematics**  ·  **Lesson 2.3 — Prismatic Joints, Mixed Chains, and the Full 6×n Jacobian**
...
<figure markdown>
  ![Prismatic Joints, Mixed Chains, and the Full 6×n Jacobian](../assets/m06-l7-prismatic-mixed-chains.svg){ width="680" }
</figure>
...
<iframe src="../../demos/module06/lesson07_jacobian_column_explorer.html" title="Prismatic Joints, Mixed Chains, and the Full 6×n Jacobian interactive demo" style="width:100%;height:520px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this demo in a new tab ↗](../demos/module06/lesson07_jacobian_column_explorer.html)
...
!!! tip "Run the hands-on notebook"
    `modules/module06/notebooks/lesson07_prismatic_mixed_chains.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module06/lesson07_quiz.html" title="Prismatic Joints, Mixed Chains, and the Full 6×n Jacobian knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module06/lesson07_quiz.html)
