!!! abstract "You are here"
    **Module 6 — Jacobians and Differential Motion**  ·  **Unit 7 — Inverse Velocity Kinematics & Resolved-Rate Motion**  ·  **Lesson 7.1 — Inverse Velocity Kinematics: From Desired Twist to Joint Rates**
...
!!! tip "Run the hands-on notebook"
    `modules/module06/notebooks/lesson25_inverse_velocity_kinematics.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module06/lesson25_quiz.html" title="Inverse Velocity Kinematics: From Desired Twist to Joint Rates knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module06/lesson25_quiz.html)
