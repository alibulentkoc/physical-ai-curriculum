!!! abstract "You are here"
    **Module 6 — Jacobians and Differential Motion**  ·  **Unit 1 — Differential Motion & Twists**  ·  **Lesson 1.4 — Transforming Twists Between Frames**
...
<iframe src="../../demos/module06/lesson04_transforming_twists.html" title="Transforming Twists Between Frames interactive demo" style="width:100%;height:520px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this demo in a new tab ↗](../demos/module06/lesson04_transforming_twists.html)
...
!!! tip "Run the hands-on notebook"
    `modules/module06/notebooks/lesson04_transforming_twists.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module06/lesson04_quiz.html" title="Transforming Twists Between Frames knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module06/lesson04_quiz.html)
