!!! abstract "You are here"
    **Module 6 — Jacobians and Differential Motion**  ·  **Unit 4 — Rank, Manipulability & the Ellipsoid**  ·  **Lesson 4.4 — Force and Velocity Duality: τ = JᵀF and the Force Ellipsoid**
...
!!! tip "Run the hands-on notebook"
    `modules/module06/notebooks/lesson16_force_velocity_duality.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module06/lesson16_quiz.html" title="Force and Velocity Duality: τ = JᵀF and the Force Ellipsoid knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module06/lesson16_quiz.html)
