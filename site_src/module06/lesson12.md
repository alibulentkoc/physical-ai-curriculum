!!! abstract "You are here"
    **Module 6 — Jacobians and Differential Motion**  ·  **Unit 3 — Analytic Jacobian, Frames & Representations**  ·  **Lesson 3.4 — Representation Singularities vs Kinematic Singularities**
...
!!! tip "Run the hands-on notebook"
    `modules/module06/notebooks/lesson12_representation_vs_kinematic_singularity.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module06/lesson12_quiz.html" title="Representation Singularities vs Kinematic Singularities knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module06/lesson12_quiz.html)
