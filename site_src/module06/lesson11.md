!!! abstract "You are here"
    **Module 6 — Jacobians and Differential Motion**  ·  **Unit 3 — Analytic Jacobian, Frames & Representations**  ·  **Lesson 3.3 — Base-Frame vs Tool-Frame Jacobian**
...
!!! tip "Run the hands-on notebook"
    `modules/module06/notebooks/lesson11_base_vs_tool_frame.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module06/lesson11_quiz.html" title="Base-Frame vs Tool-Frame Jacobian knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module06/lesson11_quiz.html)
