!!! abstract "You are here"
    **Module 6 — Jacobians and Differential Motion**  ·  **Unit 4 — Rank, Manipulability & the Ellipsoid**  ·  **Lesson 4.1 — What the Tool Can and Cannot Do: Rank, Range, and Null Space**
...
<iframe src="../../demos/module06/lesson13_rank_range_null_space.html" title="What the Tool Can and Cannot Do: Rank, Range, and Null Space interactive demo" style="width:100%;height:520px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this demo in a new tab ↗](../demos/module06/lesson13_rank_range_null_space.html)
...
!!! tip "Run the hands-on notebook"
    `modules/module06/notebooks/lesson13_rank_range_nullspace.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module06/lesson13_quiz.html" title="What the Tool Can and Cannot Do: Rank, Range, and Null Space knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module06/lesson13_quiz.html)
