!!! abstract "You are here"
    **Module 8 — Feedback Control and Real-Time Execution (ROS 2)**  ·  **Unit 7 — Embedded Execution and Real-Time Control**  ·  **Lesson 7.1 — What Real-Time Means: Deadlines, Determinism, and Worst-Case Timing**
...
<figure markdown>
  ![What Real-Time Means: Deadlines, Determinism, and Worst-Case Timing](../assets/m08-l25-realtime-deadlines.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module08/notebooks/lesson25_realtime_meaning.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module08/lesson25_quiz.html" title="What Real-Time Means: Deadlines, Determinism, and Worst-Case Timing knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module08/lesson25_quiz.html)
