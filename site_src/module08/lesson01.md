!!! abstract "You are here"
    **Module 8 — Feedback Control and Real-Time Execution (ROS 2)**  ·  **Unit 1 — The Tracking Problem and the Feedback Loop**  ·  **Lesson 1.1 — Why Open-Loop Isn't Enough: The Reference-vs-Reality Gap**
...
<figure markdown>
  ![Why Open-Loop Isn't Enough: The Reference-vs-Reality Gap](../assets/m08-l1-open-loop-drift.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module08/notebooks/lesson01_why_open_loop_fails.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module08/lesson01_quiz.html" title="Why Open-Loop Isn't Enough: The Reference-vs-Reality Gap knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module08/lesson01_quiz.html)
