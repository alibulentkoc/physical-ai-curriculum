!!! abstract "You are here"
    **Module 8 — Feedback Control and Real-Time Execution (ROS 2)**  ·  **Unit 6 — Communication**  ·  **Lesson 6.2 — Publish and Subscribe: Nodes, Topics, and Messages**
...
<figure markdown>
  ![Publish and Subscribe: Nodes, Topics, and Messages](../assets/m08-l22-publish-subscribe.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module08/notebooks/lesson22_publish_subscribe.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module08/lesson22_quiz.html" title="Publish and Subscribe: Nodes, Topics, and Messages knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module08/lesson22_quiz.html)
