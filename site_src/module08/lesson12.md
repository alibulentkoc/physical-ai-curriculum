!!! abstract "You are here"
    **Module 8 — Feedback Control and Real-Time Execution (ROS 2)**  ·  **Unit 3 — Stability, Response, and Tuning**  ·  **Lesson 3.4 — Tuning a Controller: A Practical Workflow**
...
<figure markdown>
  ![Tuning a Controller: A Practical Workflow](../assets/m08-l12-tuning-progression.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module08/notebooks/lesson12_tuning_workflow.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module08/lesson12_quiz.html" title="Tuning a Controller: A Practical Workflow knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module08/lesson12_quiz.html)
