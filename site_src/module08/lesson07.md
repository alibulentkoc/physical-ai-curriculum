!!! abstract "You are here"
    **Module 8 — Feedback Control and Real-Time Execution (ROS 2)**  ·  **Unit 2 — Proportional, Integral, and Derivative Control**  ·  **Lesson 2.3 — Derivative Control: Anticipate and Damp**
...
<figure markdown>
  ![Derivative Control: Anticipate and Damp](../assets/m08-l7-derivative.svg){ width="680" }
</figure>
...
<iframe src="../../demos/module08/lesson07_pid_playground.html" title="Derivative Control: Anticipate and Damp interactive demo" style="width:100%;height:520px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this demo in a new tab ↗](../demos/module08/lesson07_pid_playground.html)
...
!!! tip "Run the hands-on notebook"
    `modules/module08/notebooks/lesson07_derivative_control.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module08/lesson07_quiz.html" title="Derivative Control: Anticipate and Damp knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module08/lesson07_quiz.html)
