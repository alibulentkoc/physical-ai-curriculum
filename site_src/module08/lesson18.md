!!! abstract "You are here"
    **Module 8 — Feedback Control and Real-Time Execution (ROS 2)**  ·  **Unit 5 — Actuator Control**  ·  **Lesson 5.2 — Saturation and Integral Windup**
...
<figure markdown>
  ![Saturation and Integral Windup](../assets/m08-l18-saturation-windup.svg){ width="680" }
</figure>
...
<iframe src="../../demos/module08/lesson18_saturation_windup.html" title="Saturation and Integral Windup interactive demo" style="width:100%;height:520px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this demo in a new tab ↗](../demos/module08/lesson18_saturation_windup.html)
...
!!! tip "Run the hands-on notebook"
    `modules/module08/notebooks/lesson18_saturation_and_windup.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module08/lesson18_quiz.html" title="Saturation and Integral Windup knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module08/lesson18_quiz.html)
