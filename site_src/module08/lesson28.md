!!! abstract "You are here"
    **Module 8 — Feedback Control and Real-Time Execution (ROS 2)**  ·  **Unit 7 — Embedded Execution and Real-Time Control**  ·  **Lesson 7.4 — Running the Inner Loop on a Real-Time Target**
...
<figure markdown>
  ![Running the Inner Loop on a Real-Time Target](../assets/m08-l28-realtime-target.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module08/notebooks/lesson28_realtime_target.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module08/lesson28_quiz.html" title="Running the Inner Loop on a Real-Time Target knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module08/lesson28_quiz.html)
