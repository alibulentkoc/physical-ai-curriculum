!!! abstract "You are here"
    **Module 8 — Feedback Control and Real-Time Execution (ROS 2)**  ·  **Unit 4 — Tracking the Whole Arm: Feedforward and Feedback**  ·  **Lesson 4.2 — Feedback Reacts, Feedforward Anticipates**
...
<figure markdown>
  ![Feedback Reacts, Feedforward Anticipates](../assets/m08-l14-react-vs-anticipate.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module08/notebooks/lesson14_feedback_reacts_feedforward_anticipates.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module08/lesson14_quiz.html" title="Feedback Reacts, Feedforward Anticipates knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module08/lesson14_quiz.html)
