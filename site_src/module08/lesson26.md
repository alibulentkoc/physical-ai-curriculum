!!! abstract "You are here"
    **Module 8 — Feedback Control and Real-Time Execution (ROS 2)**  ·  **Unit 7 — Embedded Execution and Real-Time Control**  ·  **Lesson 7.2 — The Periodic Control Loop: Running at a Fixed Rate**
...
<figure markdown>
  ![The Periodic Control Loop: Running at a Fixed Rate](../assets/m08-l26-periodic-loop.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module08/notebooks/lesson26_periodic_control_loop.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module08/lesson26_quiz.html" title="The Periodic Control Loop: Running at a Fixed Rate knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module08/lesson26_quiz.html)
