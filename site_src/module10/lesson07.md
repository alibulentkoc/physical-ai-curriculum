!!! abstract "You are here"
    **Module 10 — Digital Twin Capstone**  ·  **Unit 2 — Building the Mirror: State Synchronization**  ·  **Lesson 2.3 — When the Mirror Drifts: Sync Error**
...
<figure markdown>
  ![When the Mirror Drifts: Sync Error](../assets/m10-l7-sync-error.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module10/notebooks/lesson07_sync_error.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module10/lesson07_quiz.html" title="When the Mirror Drifts: Sync Error knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module10/lesson07_quiz.html)
