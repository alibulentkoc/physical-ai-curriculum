!!! abstract "You are here"
    **Module 10 — Digital Twin Capstone**  ·  **Unit 7 — Adaptation: Closing the Twin-in-the-Loop**  ·  **Lesson 7.3 — The Twin-in-the-Loop Cycle**
...
<figure markdown>
  ![The Twin-in-the-Loop Cycle](../assets/m10-l27-twin-in-the-loop-cycle.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module10/notebooks/lesson27_twin_in_the_loop_cycle.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module10/lesson27_quiz.html" title="The Twin-in-the-Loop Cycle knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module10/lesson27_quiz.html)
