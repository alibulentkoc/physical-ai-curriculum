!!! abstract "You are here"
    **Module 10 — Digital Twin Capstone**  ·  **Unit 3 — Simulating the System in the Twin**  ·  **Lesson 3.4 — Unit 3 Recap: Simulating the System in the Twin**
...
<figure markdown>
  ![Unit 3 Recap: Simulating the System in the Twin](../assets/m10-l12-unit3-recap-spine.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module10/notebooks/lesson12_unit3_recap.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module10/lesson12_quiz.html" title="Unit 3 Recap: Simulating the System in the Twin knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module10/lesson12_quiz.html)
