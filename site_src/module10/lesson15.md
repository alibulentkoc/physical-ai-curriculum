!!! abstract "You are here"
    **Module 10 — Digital Twin Capstone**  ·  **Unit 4 — The Sim-to-Real Gap**  ·  **Lesson 4.3 — Calibrating the Twin: Shrinking the Gap**
...
<figure markdown>
  ![Calibrating the Twin: Shrinking the Gap](../assets/m10-l15-calibrating.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module10/notebooks/lesson15_calibrating.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module10/lesson15_quiz.html" title="Calibrating the Twin: Shrinking the Gap knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module10/lesson15_quiz.html)
