!!! abstract "You are here"
    **Module 10 — Digital Twin Capstone**  ·  **Unit 5 — Monitoring with the Twin**  ·  **Lesson 5.2 — Divergence as a Signal**
...
<figure markdown>
  ![Divergence as a Signal](../assets/m10-l18-divergence-signal.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module10/notebooks/lesson18_divergence_signal.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module10/lesson18_quiz.html" title="Divergence as a Signal knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module10/lesson18_quiz.html)
