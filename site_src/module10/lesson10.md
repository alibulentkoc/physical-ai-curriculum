!!! abstract "You are here"
    **Module 10 — Digital Twin Capstone**  ·  **Unit 3 — Simulating the System in the Twin**  ·  **Lesson 3.2 — The Twin as a Sandbox: Risk-Free Experimentation**
...
<figure markdown>
  ![The Twin as a Sandbox: Risk-Free Experimentation](../assets/m10-l10-twin-sandbox.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module10/notebooks/lesson10_twin_sandbox.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module10/lesson10_quiz.html" title="The Twin as a Sandbox: Risk-Free Experimentation knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module10/lesson10_quiz.html)
