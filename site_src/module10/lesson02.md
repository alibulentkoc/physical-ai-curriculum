!!! abstract "You are here"
    **Module 10 — Digital Twin Capstone**  ·  **Unit 1 — What Is a Digital Twin?**  ·  **Lesson 1.2 — Twin vs. Model vs. Simulation**
...
<figure markdown>
  ![Twin vs. Model vs. Simulation](../assets/m10-l2-twin-vs-model-vs-sim.svg){ width="680" }
</figure>
...
<iframe src="../../demos/module10/lesson02_twin_mirror.html" title="Twin vs. Model vs. Simulation interactive demo" style="width:100%;height:520px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this demo in a new tab ↗](../demos/module10/lesson02_twin_mirror.html)
...
!!! tip "Run the hands-on notebook"
    `modules/module10/notebooks/lesson02_twin_vs_model_vs_sim.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module10/lesson02_quiz.html" title="Twin vs. Model vs. Simulation knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module10/lesson02_quiz.html)
