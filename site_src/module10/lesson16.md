!!! abstract "You are here"
    **Module 10 — Digital Twin Capstone**  ·  **Unit 4 — The Sim-to-Real Gap**  ·  **Lesson 4.4 — Unit 4 Recap and Midpoint**
...
<figure markdown>
  ![Unit 4 Recap and Midpoint](../assets/m10-l16-midpoint-spine.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module10/notebooks/lesson16_unit4_recap_midpoint.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module10/lesson16_quiz.html" title="Unit 4 Recap and Midpoint knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module10/lesson16_quiz.html)
