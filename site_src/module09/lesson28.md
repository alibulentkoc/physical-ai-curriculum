!!! abstract "You are here"
    **Module 9 — System Integration — The Complete Physical AI System**  ·  **Unit 7 — Recover**  ·  **Lesson 7.4 — Unit 7 Recap: Recover**
...
<figure markdown>
  ![Unit 7 Recap: Recover](../assets/m09-l28-recover-recap.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module09/notebooks/lesson28_unit7_recap.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module09/lesson28_quiz.html" title="Unit 7 Recap: Recover knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module09/lesson28_quiz.html)
