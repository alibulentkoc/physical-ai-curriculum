!!! abstract "You are here"
    **Module 9 — System Integration — The Complete Physical AI System**  ·  **Unit 7 — Recover**  ·  **Lesson 7.1 — The Orchestrator: Coordination as a Stage**
...
<figure markdown>
  ![The Orchestrator: Coordination as a Stage](../assets/m09-l25-orchestrator.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module09/notebooks/lesson25_the_orchestrator.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module09/lesson25_quiz.html" title="The Orchestrator: Coordination as a Stage knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module09/lesson25_quiz.html)
