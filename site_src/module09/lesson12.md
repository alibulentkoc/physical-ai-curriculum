!!! abstract "You are here"
    **Module 9 — System Integration — The Complete Physical AI System**  ·  **Unit 3 — Understand → Plan**  ·  **Lesson 3.4 — Unit 3 Recap: Understand → Plan**
...
<figure markdown>
  ![Unit 3 Recap: Understand → Plan](../assets/m09-l12-understand-plan-bridge.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module09/notebooks/lesson12_unit3_recap.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module09/lesson12_quiz.html" title="Unit 3 Recap: Understand → Plan knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module09/lesson12_quiz.html)
