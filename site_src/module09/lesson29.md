!!! abstract "You are here"
    **Module 9 — System Integration — The Complete Physical AI System**  ·  **Unit 8 — Full System Integration**  ·  **Lesson 8.1 — The Full Pick Cycle: Six Stages as One Loop**
...
<figure markdown>
  ![The Full Pick Cycle: Six Stages as One Loop](../assets/m09-l29-full-pick-cycle.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module09/notebooks/lesson29_full_pick_cycle.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module09/lesson29_quiz.html" title="The Full Pick Cycle: Six Stages as One Loop knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module09/lesson29_quiz.html)
