!!! abstract "You are here"
    **Module 9 — System Integration — The Complete Physical AI System**  ·  **Unit 3 — Understand → Plan**  ·  **Lesson 3.3 — Integration Exercise: Pose to Plan, Wired End to End**
...
<figure markdown>
  ![Integration Exercise: Pose to Plan, Wired End to End](../assets/m09-l11-pose-to-plan-wired.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module09/notebooks/lesson11_pose_to_plan_wired.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module09/lesson11_quiz.html" title="Integration Exercise: Pose to Plan, Wired End to End knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module09/lesson11_quiz.html)
