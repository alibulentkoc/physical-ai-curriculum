...
<figure markdown>
  ![The SE(2) Transformation](../assets/m02-l11-se2-matrix.svg){ width="680" }
</figure>
...
<iframe src="../../quizzes/module02/lesson11_quiz.html" title="The SE(2) Transformation knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module02/lesson11_quiz.html)
