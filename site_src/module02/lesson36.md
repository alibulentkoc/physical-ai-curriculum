!!! abstract "You are here"
    **Module 2 — Spatial Transformations and SE(3)**  ·  **Unit 8 — Mini Project: Perception-to-Pose Pipeline**  ·  **Lesson 8.4 — Wrap-Up and the Road to Kinematics**
...
!!! tip "Run the hands-on notebook"
    `modules/module02/notebooks/M02_U08_L8_4_Wrap_Up_And_The_Road_To_Kinematics.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module02/lesson36_quiz.html" title="Wrap-Up and the Road to Kinematics knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module02/lesson36_quiz.html)
