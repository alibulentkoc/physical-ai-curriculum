!!! abstract "You are here"
    **Module 2 — Spatial Transformations and SE(3)**  ·  **Unit 7 — Camera-to-Robot Transformations**  ·  **Lesson 7.1 — The Camera Sees Its Own World**
...
<figure markdown>
  ![The Camera Sees Its Own World](../assets/m02-l29-camera-own-world.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module02/notebooks/M02_U07_L7_1_The_Camera_Sees_Its_Own_World.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module02/lesson29_quiz.html" title="The Camera Sees Its Own World knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module02/lesson29_quiz.html)
