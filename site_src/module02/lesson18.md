!!! abstract "You are here"
    **Module 2 — Spatial Transformations and SE(3)**  ·  **Unit 4 — SE(3) Transformations**  ·  **Lesson 4.4 — Translation Vectors in 3D**
...
<figure markdown>
  ![Translation Vectors in 3D](../assets/m02-l18-translation-3d.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module02/notebooks/M02_U04_L4_4_Translation_Vectors_In_3D.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module02/lesson18_quiz.html" title="Translation Vectors in 3D knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module02/lesson18_quiz.html)
