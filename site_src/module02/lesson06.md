...
<figure markdown>
  ![Points vs Directions](../assets/m02-l6-points-vs-directions.svg){ width="680" }
</figure>
...
<iframe src="../../quizzes/module02/lesson06_quiz.html" title="Points vs Directions knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module02/lesson06_quiz.html)
