!!! abstract "You are here"
    **Module 2 — Spatial Transformations and SE(3)**  ·  **Unit 3 — SE(2) Transformations**  ·  **Lesson 3.3 — Applying SE(2) to Points and Shapes**
...
<figure markdown>
  ![Applying SE(2) to Points and Shapes](../assets/m02-l12-apply-se2.svg){ width="680" }
</figure>
...
<iframe src="../../demos/module02/lesson12_se2_playground.html" title="Applying SE(2) to Points and Shapes interactive demo" style="width:100%;height:520px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this demo in a new tab ↗](../demos/module02/lesson12_se2_playground.html)
...
!!! tip "Run the hands-on notebook"
    `modules/module02/notebooks/M02_U03_L3_3_Applying_SE2_To_Points_And_Shapes.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module02/lesson12_quiz.html" title="Applying SE(2) to Points and Shapes knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module02/lesson12_quiz.html)
