!!! abstract "You are here"
    **Module 2 — Spatial Transformations and SE(3)**  ·  **Unit 7 — Camera-to-Robot Transformations**  ·  **Lesson 7.3 — Building the Transformation Chain**
...
<figure markdown>
  ![Building the Transformation Chain](../assets/m02-l31-chain.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module02/notebooks/M02_U07_L7_3_Building_The_Transformation_Chain.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module02/lesson31_quiz.html" title="Building the Transformation Chain knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module02/lesson31_quiz.html)
