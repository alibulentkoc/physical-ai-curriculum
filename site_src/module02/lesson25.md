!!! abstract "You are here"
    **Module 2 — Spatial Transformations and SE(3)**  ·  **Unit 6 — Robot Pose Representation**  ·  **Lesson 6.1 — What Is a Pose?**
...
<figure markdown>
  ![What Is a Pose?](../assets/m02-l25-what-is-pose.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module02/notebooks/M02_U06_L6_1_What_Is_A_Pose.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module02/lesson25_quiz.html" title="What Is a Pose? knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module02/lesson25_quiz.html)
