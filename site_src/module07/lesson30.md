!!! abstract "You are here"
    **Module 7 — Trajectory Generation and Motion Planning**  ·  **Unit 8 — Capstone: Plan → Parameterize → Validate → Execute**  ·  **Lesson 8.2 — Plan and Parameterize: From Task to Timed Trajectory**
...
<figure markdown>
  ![Plan and Parameterize: From Task to Timed Trajectory](../assets/m07-l30-plan-parameterize.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module07/notebooks/lesson30_plan_parameterize.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module07/lesson30_quiz.html" title="Plan and Parameterize: From Task to Timed Trajectory knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module07/lesson30_quiz.html)
