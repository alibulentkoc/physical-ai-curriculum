!!! abstract "You are here"
    **Module 7 — Trajectory Generation and Motion Planning**  ·  **Unit 5 — Feasibility: Velocity, Acceleration, and Limits**  ·  **Lesson 5.1 — Why a Trajectory Can Be Infeasible: Velocity and Acceleration Limits**
...
<figure markdown>
  ![Why a Trajectory Can Be Infeasible: Velocity and Acceleration Limits](../assets/m07-l17-limit-bars.svg){ width="680" }
</figure>
...
<iframe src="../../demos/module07/lesson17_limit_explorer.html" title="Why a Trajectory Can Be Infeasible: Velocity and Acceleration Limits interactive demo" style="width:100%;height:520px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this demo in a new tab ↗](../demos/module07/lesson17_limit_explorer.html)
...
!!! tip "Run the hands-on notebook"
    `modules/module07/notebooks/lesson17_why_infeasible_limits.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module07/lesson17_quiz.html" title="Why a Trajectory Can Be Infeasible: Velocity and Acceleration Limits knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module07/lesson17_quiz.html)
