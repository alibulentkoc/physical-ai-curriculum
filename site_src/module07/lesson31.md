!!! abstract "You are here"
    **Module 7 — Trajectory Generation and Motion Planning**  ·  **Unit 8 — Capstone: Plan → Parameterize → Validate → Execute**  ·  **Lesson 8.3 — Validate and Hand Off: The Reference Trajectory Layer**
...
<figure markdown>
  ![Validate and Hand Off: The Reference Trajectory Layer](../assets/m07-l31-reference-layer.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module07/notebooks/lesson31_validate_handoff.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module07/lesson31_quiz.html" title="Validate and Hand Off: The Reference Trajectory Layer knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module07/lesson31_quiz.html)
