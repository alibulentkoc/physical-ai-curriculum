!!! abstract "You are here"
    **Module 7 — Trajectory Generation and Motion Planning**  ·  **Unit 3 — Joint-Space Trajectories**  ·  **Lesson 3.4 — Blending for C² Continuity at Via-Points**
...
<figure markdown>
  ![Blending for C² Continuity at Via-Points](../assets/m07-l12-cubic-spline-c2.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module07/notebooks/lesson12_blending_c2_via_points.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module07/lesson12_quiz.html" title="Blending for C² Continuity at Via-Points knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module07/lesson12_quiz.html)
