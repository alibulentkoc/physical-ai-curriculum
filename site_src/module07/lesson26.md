!!! abstract "You are here"
    **Module 7 — Trajectory Generation and Motion Planning**  ·  **Unit 7 — Trajectory Quality, Validation, and Tracking Prerequisites**  ·  **Lesson 7.2 — Validating a Trajectory: The Complete Check**
...
<figure markdown>
  ![Validating a Trajectory: The Complete Check](../assets/m07-l26-validation-checklist.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module07/notebooks/lesson26_validating_trajectory.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module07/lesson26_quiz.html" title="Validating a Trajectory: The Complete Check knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module07/lesson26_quiz.html)
