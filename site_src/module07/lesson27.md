!!! abstract "You are here"
    **Module 7 — Trajectory Generation and Motion Planning**  ·  **Unit 7 — Trajectory Quality, Validation, and Tracking Prerequisites**  ·  **Lesson 7.3 — Tracking Prerequisites: What the Reference Must Provide**
...
<figure markdown>
  ![Tracking Prerequisites: What the Reference Must Provide](../assets/m07-l27-handoff-boundary.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module07/notebooks/lesson27_tracking_prerequisites.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module07/lesson27_quiz.html" title="Tracking Prerequisites: What the Reference Must Provide knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module07/lesson27_quiz.html)
