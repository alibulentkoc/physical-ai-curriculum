!!! abstract "You are here"
    **Module 7 — Trajectory Generation and Motion Planning**  ·  **Unit 4 — Cartesian-Space Trajectories**  ·  **Lesson 4.4 — Screw Motion: Unified Position + Orientation Interpolation**
...
<figure markdown>
  ![Screw Motion: Unified Position + Orientation Interpolation](../assets/m07-l16-screw-vs-decoupled.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module07/notebooks/lesson16_screw_motion_unified.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module07/lesson16_quiz.html" title="Screw Motion: Unified Position + Orientation Interpolation knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module07/lesson16_quiz.html)
