!!! abstract "You are here"
    **Module 7 — Trajectory Generation and Motion Planning**  ·  **Unit 6 — Motion Planning and Collision Awareness**  ·  **Lesson 6.3 — Finding a Safe Path: Sampling-Based Planning (RRT)**
...
<figure markdown>
  ![Finding a Safe Path: Sampling-Based Planning (RRT)](../assets/m07-l23-rrt-tree.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module07/notebooks/lesson23_rrt_planning.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module07/lesson23_quiz.html" title="Finding a Safe Path: Sampling-Based Planning (RRT) knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module07/lesson23_quiz.html)
