!!! abstract "You are here"
    **Module 7 — Trajectory Generation and Motion Planning**  ·  **Unit 1 — Motion, Paths, and Trajectories**  ·  **Lesson 1.3 — What Makes a Trajectory "Good"**
...
<figure markdown>
  ![What Makes a Trajectory "Good"](../assets/m07-l3-quality-scorecard.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module07/notebooks/lesson03_what_makes_a_trajectory_good.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module07/lesson03_quiz.html" title="What Makes a Trajectory "Good" knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module07/lesson03_quiz.html)
