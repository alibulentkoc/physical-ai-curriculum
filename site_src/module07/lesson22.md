!!! abstract "You are here"
    **Module 7 — Trajectory Generation and Motion Planning**  ·  **Unit 6 — Motion Planning and Collision Awareness**  ·  **Lesson 6.2 — Collision Checking: Is This Configuration Safe?**
...
<figure markdown>
  ![Collision Checking: Is This Configuration Safe?](../assets/m07-l22-collision-tunneling.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module07/notebooks/lesson22_collision_checking.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module07/lesson22_quiz.html" title="Collision Checking: Is This Configuration Safe? knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module07/lesson22_quiz.html)
