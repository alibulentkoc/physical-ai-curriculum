!!! abstract "You are here"
    **Module 3 — Camera Geometry and Robotic Perception**  ·  **Unit 4 — Projection in Practice**  ·  **Lesson 4.3 — Seeing It in Code (OpenCV Introduction)**
...
<figure markdown>
  ![Seeing It in Code (OpenCV Introduction)](../assets/m03-l15-opencv-match.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module03/notebooks/M03_U04_L4_3_Seeing_It_In_Code_OpenCV_Introduction.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module03/lesson15_quiz.html" title="Seeing It in Code (OpenCV Introduction) knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module03/lesson15_quiz.html)
