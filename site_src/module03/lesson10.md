!!! abstract "You are here"
    **Module 3 — Camera Geometry and Robotic Perception**  ·  **Unit 3 — Camera Intrinsics**  ·  **Lesson 3.2 — The Intrinsic Matrix K**
...
<figure markdown>
  ![The Intrinsic Matrix K](../assets/m03-l10-matrix-k.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module03/notebooks/M03_U03_L3_2_The_Intrinsic_Matrix_K.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module03/lesson10_quiz.html" title="The Intrinsic Matrix K knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module03/lesson10_quiz.html)
