!!! abstract "You are here"
    **Module 3 — Camera Geometry and Robotic Perception**  ·  **Unit 6 — Back-Projection: Pixels to 3D**  ·  **Lesson 6.3 — Back-Projection in Code**
...
<figure markdown>
  ![Back-Projection in Code](../assets/m03-l23-pointcloud.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module03/notebooks/M03_U06_L6_3_Back_Projection_In_Code.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module03/lesson23_quiz.html" title="Back-Projection in Code knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module03/lesson23_quiz.html)
