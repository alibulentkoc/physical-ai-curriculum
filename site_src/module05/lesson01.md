!!! abstract "You are here"
    **Module 5 — Inverse Kinematics**  ·  **Unit 1 — The Inverse Problem**  ·  **Lesson 1.1 — From Forward to Inverse**
...
<figure markdown>
  ![From Forward to Inverse](../assets/m05-l1-forward-to-inverse.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module05/notebooks/M05_U01_L1_1_From_Forward_To_Inverse.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module05/lesson01_quiz.html" title="From Forward to Inverse knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module05/lesson01_quiz.html)
