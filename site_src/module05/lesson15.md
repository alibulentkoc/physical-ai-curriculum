!!! abstract "You are here"
    **Module 5 — Inverse Kinematics**  ·  **Unit 4 — From Geometry to Numerical IK**  ·  **Lesson 4.3 — The Iteration Idea: Guess, Measure Error, Step**
...
<figure markdown>
  ![The Iteration Idea: Guess, Measure Error, Step](../assets/m05-l15-iteration-loop.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module05/notebooks/M05_U04_L4_3_Iteration_Idea.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module05/lesson15_quiz.html" title="The Iteration Idea: Guess, Measure Error, Step knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module05/lesson15_quiz.html)
