!!! abstract "You are here"
    **Module 4 — Forward Kinematics using Denavit–Hartenberg Parameters**  ·  **Unit 7 — Pose, Workspace, and Back to Perception**  ·  **Lesson 7.3 — Closing the Loop with Perception**
...
<figure markdown>
  ![Closing the Loop with Perception](../assets/m04-l27-closing-loop-perception.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module04/notebooks/M04_U07_L7_3_Closing_The_Loop_With_Perception.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module04/lesson27_quiz.html" title="Closing the Loop with Perception knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module04/lesson27_quiz.html)
