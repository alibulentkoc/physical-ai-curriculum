!!! abstract "You are here"
    **Module 4 — Forward Kinematics using Denavit–Hartenberg Parameters**  ·  **Unit 8 — Mini Project: From Joints to the Fruit**  ·  **Lesson 8.4 — Wrap-Up and the Road to Inverse Kinematics**
...
!!! tip "Run the hands-on notebook"
    `modules/module04/notebooks/M04_U08_L8_4_Wrap_Up_And_The_Road_To_Inverse_Kinematics.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module04/lesson32_quiz.html" title="Wrap-Up and the Road to Inverse Kinematics knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module04/lesson32_quiz.html)
