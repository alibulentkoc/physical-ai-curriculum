!!! abstract "You are here"
    **Module 3 — Camera Geometry and Robotic Perception**  ·  **Unit 6 — Back-Projection: Pixels to 3D**  ·  **Lesson 6.1 — A Pixel Is a Ray**
...
<figure markdown>
  ![A Pixel Is a Ray](../assets/m03-l21-pixel-ray.svg){ width="680" }
</figure>
...
<iframe src="../../demos/module03/lesson21_backprojection_ray.html" title="A Pixel Is a Ray interactive demo" style="width:100%;height:520px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this demo in a new tab ↗](../demos/module03/lesson21_backprojection_ray.html)
...
!!! tip "Run the hands-on notebook"
    `modules/module03/notebooks/M03_U06_L6_1_A_Pixel_Is_A_Ray.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module03/lesson21_quiz.html" title="A Pixel Is a Ray knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module03/lesson21_quiz.html)
