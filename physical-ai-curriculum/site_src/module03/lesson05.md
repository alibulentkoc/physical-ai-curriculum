!!! abstract "You are here"
    **Module 3 — Camera Geometry and Robotic Perception**  ·  **Unit 2 — The Pinhole Camera Model**  ·  **Lesson 2.1 — The Pinhole Idea**
...
<figure markdown>
  ![The Pinhole Idea](../assets/m03-l5-pinhole.svg){ width="680" }
</figure>
...
!!! tip "Run the hands-on notebook"
    `modules/module03/notebooks/M03_U02_L2_1_The_Pinhole_Idea.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module03/lesson05_quiz.html" title="The Pinhole Idea knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module03/lesson05_quiz.html)
