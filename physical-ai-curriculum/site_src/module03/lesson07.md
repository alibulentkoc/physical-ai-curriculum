!!! abstract "You are here"
    **Module 3 — Camera Geometry and Robotic Perception**  ·  **Unit 2 — The Pinhole Camera Model**  ·  **Lesson 2.3 — Perspective Projection of a 3D Point**
...
<figure markdown>
  ![Perspective Projection of a 3D Point](../assets/m03-l7-perspective.svg){ width="680" }
</figure>
...
<iframe src="../../demos/module03/lesson07_perspective_projection.html" title="Perspective Projection of a 3D Point interactive demo" style="width:100%;height:520px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this demo in a new tab ↗](../demos/module03/lesson07_perspective_projection.html)
...
!!! tip "Run the hands-on notebook"
    `modules/module03/notebooks/M03_U02_L2_3_Perspective_Projection_Of_A_3D_Point.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module03/lesson07_quiz.html" title="Perspective Projection of a 3D Point knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module03/lesson07_quiz.html)
