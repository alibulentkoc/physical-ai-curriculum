...
!!! tip "Run the hands-on notebook"
    `modules/module01/notebooks/M01_U02_L2_2_Vector_Representation.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module01/lesson08_quiz.html" title="Vector Representation knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module01/lesson08_quiz.html)
