!!! abstract "You are here"
    **Module 2 — Spatial Transformations and SE(3)**  ·  **Unit 6 — Robot Pose Representation**  ·  **Lesson 6.3 — Reading and Writing Poses**
...
<figure markdown>
  ![Reading and Writing Poses](../assets/m02-l27-read-write-pose.svg){ width="680" }
</figure>
...
<iframe src="../../demos/module02/lesson27_pose_explorer.html" title="Reading and Writing Poses interactive demo" style="width:100%;height:520px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this demo in a new tab ↗](../demos/module02/lesson27_pose_explorer.html)
...
!!! tip "Run the hands-on notebook"
    `modules/module02/notebooks/M02_U06_L6_3_Reading_And_Writing_Poses.ipynb` — open in JupyterLab and run **Kernel → Restart & Run All**.
...
<iframe src="../../quizzes/module02/lesson27_quiz.html" title="Reading and Writing Poses knowledge check" style="width:100%;height:720px;border:1px solid #e2e8f0;border-radius:12px"></iframe>

[Open this quiz in a new tab ↗](../quizzes/module02/lesson27_quiz.html)
