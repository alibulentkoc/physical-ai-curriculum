...
core_idea: "A Cartesian coordinate is an ordered set of signed distances from an origin along perpendicular axes — the formal anatomy of the readings we've been taking."
estimated_time: 40
difficulty: Introductory
prerequisites: [3.1]
learning_objectives:
  - Define a Cartesian coordinate as signed distances along perpendicular axes from an origin.
  - Read and write coordinates given an origin and axes.
  - Connect the formal definition to the frame readings from 3.1 and 3.5.
tags:
  - physical-ai
  - coordinate-frames
---
...
`[Visual: the anatomy of a Cartesian coordinate — origin, perpendicular axes, and a point reached by stepping x then y, with signs shown across quadrants]`

**Diagram Specification**
- **Objective:** make the "signed distance along each axis from an origin" definition concrete.
- **Scene:** origin at center; x and y axes; a point P with dashed guide lines to each axis showing the x-step and y-step; a faint note that the opposite side is negative.
- **Labels:** "origin (0,0)," "x = signed distance," "y = signed distance," "P = (x, y)."
- **Form:** SVG.
