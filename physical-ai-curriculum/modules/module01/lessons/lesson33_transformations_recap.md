...
unit: 04
lesson: 4.9
title: Transformations in Physical AI — Unit 4 Recap
core_idea: "A matrix is an action applied to space. Identity does nothing; rotation turns; scaling resizes; reflection mirrors; composition chains them — and order matters."
estimated_time: 25
difficulty: Review
prerequisites: [4.1, 4.2, 4.3, 4.4, 4.5, 4.6, 4.7, 4.8]
learning_objectives:
  - Consolidate identity, rotation, scaling, reflection, and composition as actions on space.
  - Answer "what can a matrix do to space?"
  - See why composition (and its order) leads into kinematics (Module 2).
tags:
  - physical-ai
  - transformations
  - recap
...
`[Visual: the five actions on one shape — identity, rotation, scaling, reflection — and a composition arrow showing two orders giving two results]`

**Diagram Specification**
- **Objective:** consolidate the unit's actions and the order-matters insight in one picture.
- **Scene:** a reference shape; small panels showing identity (unchanged), rotation, scaling, reflection; plus a composition strip showing scale→rotate vs rotate→scale ending differently.
