...
unit: 01
lesson: 1.1
title: The Robot's Constant Problem
core_idea: "A robot perpetually perceives in one frame and acts in another; it needs one reliable way to carry position-and-orientation between frames."
estimated_time: 35
difficulty: Introductory
prerequisites: [Module 1]
learning_objectives:
  - Describe the recurring "perceive here, act there" problem a robot faces.
  - Explain why moving information between frames is constant, not occasional.
  - Motivate the need for a single, reusable representation of spatial relationships.
tags:
  - physical-ai
  - transformations
  - se3
...
`[Visual: the perceive-here / act-there loop — camera sees a tomato, the same tomato must be restated in the arm's frame and the world's frame, repeatedly]`

**Diagram Specification**
- **Objective:** show that perception and action live in different frames, so restating a location is continuous.
- **Scene:** greenhouse with a tomato; a camera (perceive) and an arm/base (act) at different places; arrows "restate" linking camera→robot→world; a small loop arrow indicating "every time the robot moves, repeat."
- **Labels:** "perceive (camera)," "act (arm)," "remember (world)," "restate, constantly."
- **Form:** SVG.
