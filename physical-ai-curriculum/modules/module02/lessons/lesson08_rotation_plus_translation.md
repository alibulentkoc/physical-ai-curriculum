...
unit: 02
lesson: 2.4
title: Rotation and Translation in One Matrix
core_idea: "A single 3x3 homogeneous matrix holds a rotation block and a translation column — turn and move expressed together, the seed of SE(2)."
estimated_time: 45
difficulty: Introductory
prerequisites: [2.3]
learning_objectives:
  - Assemble a 3x3 matrix containing both rotation and translation.
  - Apply it to a homogeneous point (rotate then offset, in one multiply).
  - Read the matrix's structure: rotation block, translation column, bottom row.
tags:
  - physical-ai
  - transformations
  - homogeneous
...
`[Visual: the 3x3 matrix annotated — rotation block (upper-left), translation column (right), bottom row — and a shape that is both turned and moved by one application]`

**Diagram Specification**
- **Objective:** show the block structure and the combined turn+move effect.
- **Scene:** the 3×3 matrix with the rotation block, translation column, and bottom row color-coded/labeled; a ghost original shape and the transformed shape that is both rotated and translated, with the angle and offset marked.
- **Labels:** "rotation block R," "translation column t," "[0 0 1]," "turn + move in one matrix."
- **Form:** SVG.
