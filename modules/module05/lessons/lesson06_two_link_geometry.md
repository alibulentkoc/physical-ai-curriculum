...
`[Visual: a two-link arm reaching a target, with the base–elbow–target triangle drawn, sides L1, L2, r labeled, the elbow interior angle θ2 and the base corner angle β marked]`

**Diagram Specification**
- **Objective:** show inverse kinematics as the triangle base–elbow–gripper.
...
- **Labels:** "L₁," "L₂," "r = reach," "elbow angle θ₂," "β (base corner)," "shoulder θ₁ = atan2(y,x) − β."
- **Form:** SVG.
