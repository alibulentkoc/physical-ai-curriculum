...
unit: 03
lesson: 3.2
title: "The atan2 Tool and Choosing the Right Quadrant"
core_idea: "atan2(y, x) recovers an angle in the correct quadrant from a vector's two components, where arctan(y/x) cannot. It is the workhorse of analytical inverse kinematics, and using it correctly is what makes closed-form solutions robust."
estimated_time: 40
difficulty: Core
prerequisites: [3.1]
learning_objectives:
  - Explain why atan2 recovers the correct quadrant and arctan does not.
  - Apply atan2 to angle extraction in inverse kinematics.
  - Avoid the common sign and quadrant errors in closed-form solutions.
tags:
  - physical-ai
  - kinematics
  - inverse-kinematics
...
`[Visual: the four quadrants with two opposite vectors (1,1) and (−1,−1); arctan collapses both to 45°, atan2 distinguishes them as 45° and −135°]`

**Diagram Specification**
- **Objective:** show the quadrant ambiguity arctan creates and atan2 resolves.
- **Scene:** an $xy$-plane with the four quadrants shaded faintly; vector to $(1,1)$ labeled "atan2 = 45°"; vector to $(-1,-1)$ labeled "atan2 = −135°"; a note "arctan(y/x) = 45° for BOTH" with a warning mark.
- **Labels:** "same slope y/x," "opposite directions," "atan2 uses both signs," "arctan loses the quadrant."
- **Form:** SVG.
