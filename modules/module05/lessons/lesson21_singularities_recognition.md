...
unit: 06
lesson: 6.1
title: "Singularities: Where IK Breaks Down (Recognition)"
core_idea: "At a singular configuration the arm momentarily loses the ability to move the gripper in some direction — the Jacobian drops rank. We learn to recognize these poses (arm straight or fully folded for the 2-link arm); their full theory is Module 6."
estimated_time: 45
difficulty: Core
prerequisites: [5.4]
learning_objectives:
  - Describe a singularity as a lost gripper direction (rank drop of J).
  - Recognize the singular configurations of the planar 2-link arm.
  - Explain why numerical IK degrades near singularities.
tags:
  - physical-ai
  - kinematics
  - inverse-kinematics
...
`[Visual: a 2-link arm at the straight-arm singularity; the gripper can move tangentially (allowed) but not radially outward (lost direction, red X)]`

**Diagram Specification**
- **Objective:** show a singularity as a lost direction of gripper motion.
- **Scene:** a nearly-straight 2-link arm; at the gripper, a green double arrow tangent to the reach circle labeled "still possible," and a red arrow pointing radially outward with an X labeled "lost direction"; a note "det J = L₁L₂ sin θ₂ = 0 at θ₂ = 0° (straight) or 180° (folded)."
- **Labels:** "singularity: J drops rank," "tangential ✓," "radial ✗," "workspace boundary."
- **Form:** SVG. Plus the interactive singularity visualizer below.
