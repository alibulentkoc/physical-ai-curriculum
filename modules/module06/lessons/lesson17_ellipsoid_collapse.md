...
unit: 05
lesson: 5.1
title: "When the Ellipsoid Collapses: Singularity as Lost Motion"
core_idea: "A kinematic singularity is, geometrically, the moment the manipulability ellipsoid flattens: one axis shrinks to zero, so the tool loses the ability to move in that direction while still moving freely in the directions that remain."
estimated_time: "40 min"
difficulty: "Intermediate"
prerequisites:
  - "M6 L4.2 — The manipulability ellipsoid (easy/hard/impossible axes)"
  - "M6 L4.1 — Rank, range, and impossible directions"
  - "M6 L3.4 — Kinematic vs representation singularity"
learning_objectives:
  - "See a singularity as the ellipsoid flattening — a lost direction of motion."
  - "Identify which direction is lost and which remain available at a singular pose."
  - "Connect the collapse to rank loss without yet invoking matrix factorization."
  - "Use the Ellipsoid Collapse demo to feel the geometry before the algebra."
tags:
  - singularity
...
`[Visual: a sequence of three manipulability ellipses as a 2R arm straightens — round, then elongated, then collapsed to a line — with the surviving direction and the lost direction marked at the collapse]`
