...
unit: 04
lesson: 4.3
title: "Putting a Number on It: The Yoshikawa Manipulability Measure"
core_idea: "Once you can see the capability ellipsoid, one number summarizes it: Yoshikawa's measure w = √det(JJᵀ), the ellipsoid's volume — large when the robot moves freely in all directions, shrinking to zero at a singularity."
estimated_time: "35 min"
difficulty: "Intermediate"
prerequisites:
  - "M6 L4.2 — The manipulability ellipsoid (axes = singular values)"
  - "M6 L4.1 — Rank and singularities"
  - "Determinants; product of singular values"
learning_objectives:
  - "Define the Yoshikawa measure w = √det(JJᵀ) as the ellipsoid's volume."
  - "Relate w to the product of singular values and to |det J| for square J."
  - "Use w → 0 as a scalar singularity indicator, and discuss its blind spot (isotropy)."
  - "Keep the measure subordinate to the capability picture."
tags:
...
`[Visual: three ellipses with their measures — a round isotropic one (large w), an elongated one (smaller w), and a nearly flat one approaching a line (w → 0) — over a small workspace heatmap of w]`
