...
unit: 01
lesson: 1.2
title: "Angular Velocity and the Skew Operator"
core_idea: "Angular velocity ω is the instantaneous axis-and-rate of a turning body; letting a differential rotation accrue over time turns the static nudge of Lesson 1.1 into continuous motion, governed by Ṙ = S(ω)R — the law a robot's gyroscope integrates in real time."
estimated_time: "35 min"
difficulty: "Intermediate"
prerequisites:
  - "M6 L1.1 — Differential rotation and the skew operator S(·)"
  - "M2 — Rotation matrices and their properties"
  - "Calculus: differentiating a matrix-valued function of time"
learning_objectives:
  - "Picture angular velocity ω as a turning body's instantaneous axis (direction) and rate (length)."
  - "Read the motion law Ṙ = S(ω)R as 'how a rotating frame evolves moment to moment'."
  - "Distinguish the same spin seen in the world frame (ωₛ) from the body frame (ω_b)."
  - "Recognize Ṙ = S(ω)R as the relation an IMU integrates to track orientation."
tags:
  - angular-velocity
  - skew-symmetric
  - rotation-kinematics
...
`[Visual: a three-panel sequence — the same body shown turning at t and t+dt with its angular-velocity arrow, then the one spin read in the world frame versus the body frame]`
