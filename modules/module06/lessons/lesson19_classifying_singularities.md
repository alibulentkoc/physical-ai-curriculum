...
unit: 05
lesson: 5.3
title: "Classifying Singularities: Shoulder, Elbow, and Wrist"
core_idea: "On a typical 6-DOF arm with a spherical wrist the Jacobian decouples, so singularities fall into three nameable, geometric kinds — shoulder (wrist center over the base axis), elbow (arm fully extended), and wrist (two wrist axes aligned) — each a specific posture you can picture."
estimated_time: "40 min"
difficulty: "Intermediate"
prerequisites:
  - "M6 L5.1–5.2 — Singularity as lost motion; boundary vs internal"
  - "M6 L2.2 — The revolute column z × (oₙ − o)"
  - "M2 — Spherical wrists / 6-DOF arm structure"
learning_objectives:
  - "Explain how a spherical wrist decouples the Jacobian into arm and wrist parts."
  - "Picture and identify shoulder, elbow, and wrist singularities geometrically."
  - "Recognize each as a specific rank-dropping alignment."
  - "Predict which task direction is lost for each type."
tags:
...
`[Visual: three sketches of an anthropomorphic arm — (1) elbow: fully extended; (2) shoulder: wrist center on the vertical base axis; (3) wrist: two wrist axes collinear — each annotated with the lost direction]`
