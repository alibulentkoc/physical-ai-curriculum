...
unit: 06
lesson: 6.3
title: "The Four Fundamental Subspaces of the Jacobian"
core_idea: "The SVD partitions joint space and task space into four meaningful subspaces — the joint directions that move the tool (row space) and those that don't (null space / self-motion), and the tool directions the robot can reach (range) and those it cannot (the impossible directions) — making the Unit 4 capability buckets precise."
estimated_time: "40 min"
difficulty: "Intermediate"
prerequisites:
  - "M6 L6.1 — SVD: U (output), Σ, V (input)"
  - "M6 L4.1 — Range, impossible directions, null space (capability buckets)"
  - "M6 L5.1 — Lost vs remaining directions"
learning_objectives:
  - "Map the four fundamental subspaces of J to robot capability via the SVD."
  - "Identify range, null space, row space, and left-null space and their physical meaning."
  - "See how the SVD makes the Unit 4 capability buckets exact and computable."
  - "Connect the left-null space to impossible directions at a singularity."
tags:
  - four-subspaces
  - svd
  - null-space
...
`[Visual: two boxes — joint space split into row space (moves the tool) and null space (self-motion), and task space split into range (reachable) and left-null space (impossible) — with J mapping row space onto range and the null/left-null marked as the zero-gain parts]`
