...
unit: 06
lesson: 6.2
title: "Singular Values and the Condition Number"
core_idea: "The singular values measure the ellipsoid's axis lengths, and their ratio — the condition number σ_max/σ_min — measures its shape: a round ellipsoid (condition near 1) moves equally well in all directions, while a needle-thin one (large condition) is nearly singular, fixing the isotropy blind spot the Yoshikawa measure left open."
estimated_time: "35 min"
difficulty: "Intermediate"
prerequisites:
  - "M6 L6.1 — SVD as the ellipsoid's anatomy"
  - "M6 L4.3 — Yoshikawa measure and its isotropy blind spot"
  - "M6 L5.1 — Singularity as a collapsing axis"
learning_objectives:
  - "Interpret singular values as ellipsoid axis lengths (gains)."
  - "Define the condition number as σ_max/σ_min and read it as shape/isotropy."
  - "Use the condition number to fix the Yoshikawa volume blind spot."
  - "Relate a diverging condition number to nearness to a singularity."
tags:
  - singular-values
  - condition-number
  - isotropy
...
`[Visual: two ellipses of equal area — one round (condition ≈ 1, "isotropic, healthy") and one needle-thin (large condition, "near singular") — with a κ = σ_max/σ_min readout under each]`
