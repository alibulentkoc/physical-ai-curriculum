...
unit: 05
lesson: 5.4
title: "Singularity Loci and Workspace Boundaries; from M5 Recognition to Full Theory"
core_idea: "The singular configurations of an arm form a set you can map — for the planar 2R it is exactly θ₂ = 0, π, which traces the inner and outer circles of the reachable workspace — turning Module 5's 'recognize det J = 0' into a full geometric theory of where mobility is lost."
estimated_time: "35 min"
difficulty: "Intermediate"
prerequisites:
  - "M6 L5.1–5.3 — Singularity as lost motion; boundary/internal; classification"
  - "M5 — Recognizing det J = 0 (planar 2R)"
  - "M6 L4.3 — w = |L₁L₂ sin θ₂| for the planar 2R"
learning_objectives:
  - "Define the singularity locus as the set of configurations where J loses rank."
  - "Map the planar 2R locus (θ₂ = 0, π) and connect it to the workspace boundary circles."
  - "Relate boundary singularities to the edges of the reachable workspace."
  - "Upgrade M5's recognition of det J = 0 into a full classification."
tags:
  - singularity-locus
  - workspace-boundary
  - planar-2R
...
`[Visual: the planar 2R workspace annulus with the outer circle (reach L₁+L₂, arm straight) and inner circle (reach |L₁−L₂|, arm folded) both highlighted as the singularity locus; a small inset of w = |L₁L₂ sin θ₂| vanishing at θ₂ = 0, π]`
