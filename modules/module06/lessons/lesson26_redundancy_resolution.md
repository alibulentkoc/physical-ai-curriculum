...
unit: 07
lesson: 7.2
title: "Redundancy Resolution: The Pseudoinverse and Null-Space Motion"
core_idea: "A redundant arm has infinitely many joint-rate solutions for one desired tool motion; the pseudoinverse picks the smallest-effort one, and the leftover null-space freedom can be used for secondary goals — posture, joint limits, obstacle avoidance — all without disturbing the tool."
estimated_time: "40 min"
difficulty: "Intermediate"
prerequisites:
  - "M6 L7.1 — Inverse velocity kinematics (square case)"
  - "M6 L6.3 — Range and null space via the SVD"
  - "M6 L6.4 — The pseudoinverse J⁺"
learning_objectives:
  - "Explain why a redundant arm has a family of joint-rate solutions."
  - "Use the pseudoinverse for the minimum-norm solution."
  - "Add null-space motion for a secondary objective without changing the tool twist."
  - "Keep the formulation purely kinematic (velocity layer)."
tags:
  - redundancy
  - pseudoinverse
  - null-space
...
`[Visual: a redundant 3-link arm reaching one tool point in two postures (same tool, different elbow) connected by a null-space self-motion arrow; alongside, the solution written as a minimum-norm part (range) plus a null-space part (secondary goal)]`
