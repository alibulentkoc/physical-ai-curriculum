...
unit: 05
lesson: 5.2
title: Order Matters, Revisited
core_idea: "Transform composition is non-commutative: swapping the order of a rotation and a translation generally lands in a different place."
estimated_time: 45
difficulty: Introductory
prerequisites: [5.1]
learning_objectives:
  - Demonstrate that T2·T1 generally differs from T1·T2.
  - Explain why order matters once translation is involved.
  - Predict the effect of swapping transform order.
tags:
  - physical-ai
  - transformations
  - composition
...
`[Visual: same rotation and translation applied in both orders to one shape, landing in two different poses]`

**Diagram Specification**
- **Objective:** show T·R vs R·T producing different results.
- **Scene:** two panels sharing a start shape (ghost). Left: rotate-then-translate result. Right: translate-then-rotate result. The two end poses are visibly different; the same θ and (tx,ty) labeled on both.
- **Labels:** "rotate then translate (T·R)," "translate then rotate (R·T)," "different endings — order matters."
- **Form:** SVG.
