...
unit: 02
lesson: 2.3
title: Translation as a Matrix
core_idea: "With homogeneous coordinates, translation is a 3x3 matrix with the offset in the last column — the move that no 2x2 matrix could do."
estimated_time: 45
difficulty: Introductory
prerequisites: [2.2]
learning_objectives:
  - Write the 3x3 homogeneous translation matrix.
  - Apply it to a homogeneous point and recover the translated point.
  - Confirm translation now composes with other transforms by multiplication.
tags:
  - physical-ai
  - transformations
  - homogeneous
...
`[Visual: the 3x3 translation matrix with the offset in the last column, sliding a shape across the plane; a point picks up the offset, a direction does not]`

**Diagram Specification**
- **Objective:** show the translation matrix structure and its effect (a pure slide).
- **Scene:** the 3×3 matrix with t_x, t_y highlighted in the last column; a ghost original shape and the slid shape with the offset vector drawn; a small note "direction (w=0) unaffected."
- **Labels:** "T(t_x, t_y)," "offset in last column," "pure slide," "bottom row [0 0 1]."
- **Form:** SVG.
