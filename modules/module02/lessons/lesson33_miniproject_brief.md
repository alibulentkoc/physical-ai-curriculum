...
unit: 08
lesson: 8.1
title: "The Mini Project: From Detection to Reach"
core_idea: "The capstone turns a detected tomato into a world-frame target by composing the full pose chain — integrating everything in Module 2."
estimated_time: 35
difficulty: Capstone
prerequisites: [7.4]
learning_objectives:
  - State the perception-to-pose problem the project solves.
  - Identify the given quantities and the goal pose.
  - See how every Module 2 idea contributes to the pipeline.
tags:
  - physical-ai
  - transformations
  - capstone
...
`[Visual: the project at a glance — detected tomato in camera frame, extrinsics, arm pose, composed into a world-frame target the arm reaches]`

**Diagram Specification**
- **Objective:** show the project's inputs and output as a single composed chain.
- **Scene:** faux-3D isometric greenhouse: camera (with detected tomato pose), arm (extrinsics link), world frame; the composed product placing the tomato in the world; an arm reaching the world target.
- **Labels:** "given: detection, extrinsics, arm pose," "find: tomato world pose," "T(world←tomato) = T(world←arm)·T(arm←cam)·T(cam←tomato)."
