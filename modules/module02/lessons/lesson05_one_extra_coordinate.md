...
unit: 02
lesson: 2.1
title: The Idea — One Extra Coordinate
core_idea: "Adding a single extra coordinate to a point lets translation become a matrix multiplication, the same way rotation already is."
estimated_time: 40
difficulty: Introductory
prerequisites: [1.4]
learning_objectives:
  - Write a 2D point in homogeneous form (x, y, 1).
  - Explain intuitively why the extra coordinate enables translation as a matrix.
  - Recognize homogeneous coordinates as a representation, not a new geometry.
tags:
  - physical-ai
  - transformations
  - homogeneous
...
`[Visual: the 2D floor lifted to the height-1 plane in 3D; a point (x,y) shown as (x,y,1); a note that a shear up there is a slide down here]`

**Diagram Specification**
- **Objective:** convey "lift each point to (x, y, 1)" and why that unlocks translation, without heavy 3D.
- **Scene:** faux-3D isometric: a ground plane at height 1 with a point (x,y,1); a faint arrow showing that a shear in the lifted space projects to a translation on the plane; the homogeneous vector [x, y, 1] shown.
- **Labels:** "lift to (x, y, 1)," "height-1 plane," "shear up here = slide down here."
