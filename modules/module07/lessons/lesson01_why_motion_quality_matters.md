...
unit: 01
lesson: 1.1
title: "Why Smooth, Safe, Efficient Motion Matters"
core_idea: "Motion quality — smoothness, safety, efficiency — is something an engineer designs on purpose, not a free byproduct of reaching the target; the same end pose can be approached by motions that are gentle and reliable or violent and damaging."
estimated_time: "30 min"
difficulty: "Introductory"
prerequisites:
  - "M5 — Inverse kinematics (a target pose maps to joint values)"
  - "M6 — The velocity layer: commanded tool twist → joint rates (D-060)"
learning_objectives:
  - "Explain why how a robot moves matters as much as where it ends up."
  - "Name the three motion-quality goals — smooth, safe, efficient — and what each protects."
  - "Connect jerky motion to concrete greenhouse failures: bruised fruit, mechanism wear, collisions."
  - "Locate Module 7 in the pipeline: it shapes the motion the M6 velocity layer executes and the M8 controller tracks."
tags:
  - physical-ai
  - robotics
  - trajectory
...
`[Visual: two arms reaching the same tomato — a jerky "snap" path with a sharp velocity spike, and a smooth "ease-in/ease-out" path with a rounded velocity curve]`

**Diagram Specification**

- **Objective:** show that the *same start and same target* admit a violent motion and a gentle one — the difference is the speed-vs-time shape, not the destination.
- **Scene:** a greenhouse panel. Left: the 2-link arm (L₁=0.4, L₂=0.3) "snapping" to a tomato, with a tiny burst/impact mark at the fruit and a speed-vs-time inset that shoots up and drops to zero abruptly. Right: the same arm easing to the same tomato, with a rounded speed-vs-time inset (starts at 0, rises, falls back to 0).
- **Labels:** "same target pose," "jerky: bruised fruit, hardware shock," "smooth: gentle contact," and the two speed curves labelled "abrupt" / "eased."
- **Form:** SVG. Use ink `#0f172a` for the arm, rose `#e11d48` for the fruit, error `#b91c1c` for the abrupt curve, act/emerald `#10b981` for the smooth curve.
