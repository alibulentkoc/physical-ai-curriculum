...
unit: 04
lesson: 4.2
title: "Measuring the Gap: Divergence Metrics"
core_idea: "A gap you can't measure, you can't manage. To use the sim-to-real gap, you must quantify it: compare the twin's predicted harvest to reality's actual harvest and count the differences — fruit harvested in one but not the other, fruit skipped in one but not the other, attempts that differ. This outcome-level divergence metric turns a vague 'they disagree' into a precise number you can track, threshold, and shrink. Measurement is what makes the gap actionable."
estimated_time: "45 min"
difficulty: "Advanced"
prerequisites:
  - "4.1 — why twin and reality diverge"
learning_objectives:
  - "Define an outcome-level divergence metric between predicted and actual harvests."
  - "Compute the gap as differences in harvested/skipped sets and attempts."
  - "Explain why measuring the gap makes it actionable."
tags:
  - physical-ai
  - robotics
  - digital-twin
...
`[Visual: two outcome columns (Twin predicted | Reality actual) with fruit rows; matching rows greyed, disagreeing rows highlighted (one "✓ vs ✗", one attempt-count mismatch); a tally box "n_diffs = 2 · match = false · F3 predicted-harvested/actually-skipped"; a note "score the forecast against reality".]`

**Diagram Specification**
- **Objective:** show the outcome gap as a scored comparison of predicted vs actual harvest.
- **Scene:** two outcome columns with matching rows greyed and disagreeing rows highlighted, plus a tally box.
- **Labels:** "Twin predicted", "Reality actual", "disagreement (✓ vs ✗)", "n_diffs", "match = false".
- **Form:** SVG.
