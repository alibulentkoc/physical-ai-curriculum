...
unit: 01
lesson: 1.3
title: "What We Twin: the Module 9 System as the Physical Asset"
core_idea: "A twin needs a real asset to mirror, and ours is the Module 9 integrated robot. Module 9 handed us four things the twin builds on: the integrated orchestrator (harvest_row), the world-state model, the health signals, and the system interface. The twin wraps these — it reads what the real system reports and reuses its layers — and adds nothing of its own to the robot. Knowing exactly what we are twinning, and what it already provides, is the foundation for building the mirror."
estimated_time: "40 min"
difficulty: "Advanced"
prerequisites:
  - "1.2 — Twin vs. model vs. simulation"
  - "Module 9 — the orchestrator, world-state, health signals, system interface"
learning_objectives:
  - "Identify the four Module 9 inputs the twin builds on."
  - "Explain how the twin wraps the M9 interface without redefining it."
  - "Read the reported world-state that the twin will mirror."
tags:
  - physical-ai
  - robotics
  - digital-twin
...
`[Visual: a box "Module 9 system (the physical asset)" exposing four labelled ports — orchestrator (harvest_row), world-state model, health signals, system interface — with a thin "Twin wrapper" shell reading from those ports; a banner "wrap, do not redefine — the twin adds nothing to the robot".]`

**Diagram Specification**
- **Objective:** inventory the four M9 inputs and show the twin as a thin wrapper reading them.
- **Scene:** the M9 system box with four ports; a twin shell reading the ports.
- **Labels:** "orchestrator (harvest_row)", "world-state model", "health signals", "system interface", "wrap, do not redefine".
- **Form:** SVG.
