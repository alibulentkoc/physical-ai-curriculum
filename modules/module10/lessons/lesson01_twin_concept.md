...
unit: 01
lesson: 1.1
title: "The Twin Concept: A Living Mirror of the Robot"
core_idea: "A digital twin is a living virtual replica of a real system that runs alongside it and mirrors its state. It is not a one-off model and not a generic simulation — it is paired with a specific running asset (our Module 9 greenhouse robot) and kept in step with it. The twin's value is that you can look at it, experiment on it, and reason about the real robot through it, without touching the real robot. This module builds that twin on top of the system Module 9 produced."
estimated_time: "40 min"
difficulty: "Advanced"
prerequisites:
  - "Module 9 — the integrated greenhouse robot the twin mirrors"
learning_objectives:
  - "Define a digital twin as a live, paired virtual replica of a specific real system."
  - "Explain why a twin is valuable: observe, experiment, and reason without touching reality."
  - "Place the twin alongside the Module 9 system as the asset being twinned."
tags:
  - physical-ai
  - robotics
  - digital-twin
...
`[Visual: two side-by-side greenhouse robots — "Real (Module 9 system)" on the left and "Digital Twin" on the right — with a "mirror / sync" arrow carrying the reported state from real to twin; a magnifying glass and a flask icon over the twin labelled "observe · experiment · reason — without touching the real robot"; a small note "paired · live · mirroring".]`

**Diagram Specification**
- **Objective:** show the twin as a live, paired mirror of the Module 9 system.
- **Scene:** real robot and twin side by side; a sync arrow real→twin; observe/experiment icons over the twin.
- **Labels:** "Real (M9 system)", "Digital Twin", "mirror / sync", "observe · experiment · reason", "paired · live · mirroring".
- **Form:** SVG.
