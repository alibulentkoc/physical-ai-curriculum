...
unit: 05
lesson: 5.4
title: "Unit 5 Recap: Monitoring with the Twin"
core_idea: "Unit 5 made the twin a live monitor. Monitoring is a Reality ↔ Twin comparison answering 'what is happening now?'; divergence is the signal, read in two forms (state and outcome) built in earlier installments; and because that divergence is localised and directional, it becomes diagnosis, not just detection. The monitor uses the same model and the same divergence tools the twin already had — no new theory. Next, Unit 6 turns the same twin from answering 'what is happening now?' to 'what is likely to happen next?'"
estimated_time: "30 min"
difficulty: "Advanced"
prerequisites:
  - "5.1–5.3 — comparison, signal, diagnosis"
learning_objectives:
  - "Consolidate monitoring as Reality ↔ Twin comparison with divergence as signal."
  - "Recall the two divergence signals and how divergence becomes diagnosis."
  - "Set up the shift from 'now' (monitor) to 'next' (predict)."
tags:
  - physical-ai
  - robotics
  - digital-twin
...
`[Visual: the spine with Model · Mirror · Simulate · Monitor lit (Monitor newly added) and Predict · Adapt greyed; a monitor panel showing Reality ↔ Twin comparison with a divergence-to-diagnosis flow; an arrow from "what is happening now?" toward a greyed "what is likely to happen next? → Unit 6".]`

**Diagram Specification**
- **Objective:** consolidate Unit 5 on the spine and set up the now→next shift to Unit 6.
- **Scene:** spine (Monitor newly lit) + monitor panel (compare → divergence → diagnosis); arrow now→next.
- **Labels:** "Monitor ✓", "Reality ↔ Twin", "divergence → diagnosis", "what is happening now? → what next? (Unit 6)".
- **Form:** SVG.
