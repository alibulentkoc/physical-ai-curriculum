...
prerequisites: [2.5]
learning_objectives:
  - Define a unit vector and normalize a vector.
  - Use standard basis vectors to express any vector.
  - Separate direction from magnitude for control.
tags:
  - physical-ai
  - vectors
  - unit-vectors
...
- **Animation Notes:** the long arrow slides its head down to length 1; then "× distance" stretches it back out, showing reconstruction.
