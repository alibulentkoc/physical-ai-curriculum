...
learning_objectives:
  - Compute the distance between two points as the magnitude of their difference.
  - Apply distance to reachability and nearest-target selection.
  - Recognize that distances depend on a shared frame, motivating Unit 3.
tags:
  - physical-ai
  - vectors
  - distance
...
- **Animation Notes:** in panel B, animate the false subtraction producing an obviously wrong arrow, then cut back to panel A's correct one.
