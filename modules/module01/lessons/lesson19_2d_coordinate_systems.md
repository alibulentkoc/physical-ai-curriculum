...
unit: 03
lesson: 3.3
title: 2D Coordinate Systems
core_idea: "A 2D coordinate system locates any point in a plane with an (x, y) pair; the four quadrants come from the two signs."
estimated_time: 40
difficulty: Introductory
prerequisites: [3.2]
learning_objectives:
  - Locate any point in a plane using an (x, y) pair.
  - Identify the four quadrants from the signs of x and y.
  - Apply a 2D frame to a top-down greenhouse map.
tags:
  - physical-ai
  - coordinate-frames
---
...
`[Visual: a 2D plane with labeled axes, the four quadrants and their sign patterns, and a couple of located points]`

**Diagram Specification**
- **Objective:** show that an (x, y) pair locates any point and that signs determine quadrant.
- **Scene:** x and y axes through a central origin; four quadrants lightly shaded/labeled I–IV with their sign patterns; two example points placed in different quadrants with their coordinates.
- **Labels:** "I (+,+)," "II (−,+)," "III (−,−)," "IV (+,−)," origin.
- **Form:** SVG.
