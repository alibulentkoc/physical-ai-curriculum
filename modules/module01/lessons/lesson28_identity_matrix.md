...
core_idea: "The identity matrix is the 'do nothing' operator: apply it and every point stays exactly where it was."
estimated_time: 35
difficulty: Introductory
prerequisites: [4.1]
learning_objectives:
  - Define the identity matrix as the operator that leaves space unchanged.
  - Verify that applying the identity returns every point unchanged.
  - Explain the identity's role as the neutral element of transformations.
tags:
  - physical-ai
  - transformations
---
...
`[Visual: a shape passing through an "identity" machine and emerging unchanged; unit arrows land on themselves]`

**Diagram Specification**
- **Objective:** show that the identity leaves a shape (and the unit arrows) exactly where they were.
- **Scene:** left: original shape + unit arrows; an "I" machine; right: identical shape + identical arrows; a note "input = output."
- **Labels:** "identity I," "do nothing," "e1 to e1, e2 to e2," "input = output."
- **Form:** SVG.
