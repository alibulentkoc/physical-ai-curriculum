...
unit: 03
lesson: 3.1
title: "When Correction Goes Wrong: From Too Weak to Runaway"
core_idea: "One knob — the controller's strength — decides how the whole loop behaves. Turn it too low and the joint lags and sags; raise it and tracking sharpens; raise it too far and the joint overshoots, then rings, then (with delay in the loop) runs away. Before any vocabulary, you watch these behaviours emerge from a single gain and learn to recognise them by eye. The names come later."
estimated_time: "40 min"
difficulty: "Beginner"
prerequisites:
  - "M8 L2.4 — The PID controller"
  - "M8 L1.3 — The feedback loop"
learning_objectives:
  - "Recognise, by behaviour alone, the spectrum from too-weak to runaway correction."
  - "Predict qualitatively how a joint responds as the controller's strength increases."
  - "Explain that good control is a balance, not a maximum, of corrective strength."
---
...
`[Visual: a single step target with five overlaid response curves driven by increasing corrective strength — (1) too weak: slow, settles short; (2) good: smooth arrival; (3) too strong: overshoot then ring-down; (4) oscillation: sustained ringing; (5) runaway: growing swings off the chart — arranged as a left-to-right "strength" spectrum]`

**Diagram Specification**

- **Objective:** show, in one figure, the behavioural spectrum that increasing corrective strength produces — recognition before vocabulary.
- **Scene:** a position-vs-time plot with a dashed **target line**. Five response curves, each labelled by behaviour (not by gain value): **too weak** (slow rise, settles below target), **good** (smooth, reaches target), **too strong** (overshoots, rings down to target), **oscillation** (sustained equal-amplitude ringing about target), **runaway** (oscillations growing, leaving the top of the plot). A horizontal "corrective strength →" arrow beneath, low on the left, high on the right.
- **Labels:** "target", "too weak (sluggish)", "good (clean)", "too strong (overshoot)", "oscillation", "runaway (diverges)", "corrective strength →".
- **Form:** SVG, five real step-response curves from the engine + target line + strength arrow. Weak muted, good emerald `#10b981`, too-strong amber `#d97706`, oscillation sky `#0ea5e9`, runaway rose `#e11d48`.
