...
unit: 03
lesson: 3.3
title: "Stable, Marginal, Unstable — and What Tips a Loop Over"
core_idea: "Three words capture how a loop ends up: stable (settles), marginal (oscillates forever), unstable (diverges). A loop tips from one to the next when correction becomes too aggressive for how fast it actually arrives — too much gain, too little damping, or too much delay. Recognising which regime you're in, and what pushes you toward the bad ones, is the safety knowledge of feedback control."
...
learning_objectives:
  - "Classify a response as stable, marginal, or unstable from its envelope."
  - "Explain the three things that tip a loop toward instability: too much gain, too little damping, too much delay."
  - "Explain why latency is as dangerous as excessive gain."
---
...
`[Visual: three stacked response envelopes — STABLE (oscillation shrinking to a flat line at target), MARGINAL (constant-amplitude ringing forever), UNSTABLE (oscillation growing and leaving the frame) — beside a small "causes" panel listing too much gain, too little damping, too much delay]`

**Diagram Specification**

- **Objective:** make the three stability regimes unmistakable by their envelopes, and attach the three causes.
- **Scene:** three small stacked plots sharing a target line. Top **STABLE**: a damped oscillation whose envelope shrinks to the target (draw the decaying envelope as a faint shrinking outline). Middle **MARGINAL**: equal-amplitude ringing about the target (faint constant outline). Bottom **UNSTABLE**: growing oscillation leaving the top/bottom of its frame (faint widening outline). To the right, a compact "What tips it over" list: "↑ gain", "↓ damping", "↑ delay".
- **Labels:** "STABLE — settles", "MARGINAL — rings forever", "UNSTABLE — diverges", and the three causes.
- **Form:** SVG, three envelope plots + causes panel. Stable emerald `#10b981`, marginal amber `#d97706`, unstable rose `#e11d48`; envelopes drawn as faint dashed outlines.
