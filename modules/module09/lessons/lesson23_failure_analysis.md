...
unit: 06
lesson: 6.3
title: "Failure Analysis — What Failed, Where, and Who Owns the Fix"
core_idea: "Detection fires an event; analysis turns that event into a decision-ready localisation by answering, in order, three questions: what failed, where did it fail, who owns the fix. We walk the four hard faults through this triad — no-target, unreachable, invalid-plan, tracking-failure — assigning each a clear owner. This is the discipline the Architect insists on before any recovery: you do not fix what you have not localised, and you do not localise without naming the owner."
estimated_time: "50 min"
difficulty: "Intermediate"
prerequisites:
  - "6.1 — The failure taxonomy"
  - "6.2 — Detecting failure with guards"
learning_objectives:
  - "Apply the What / Where / Who triad to each hard fault."
  - "Assign an owner (the stage responsible for the fix) to each failure."
  - "Explain why localisation precedes recovery."
tags:
  - physical-ai
  - robotics
  - systems-integration
...
`[Visual: four fault cards, each a row of three answer-boxes — What / Where / Who — filled for NO_TARGET, UNREACHABLE, PLAN_INVALID, TRACKING_FAILURE; an arrow showing "where it surfaced" can differ from "who owns the fix" (UNREACHABLE surfaces at IK seam, owned by Understand); a banner "localise before recover".]`

**Diagram Specification**
- **Objective:** show each hard fault resolved into the What/Where/Who triad, with surfaced-vs-owner highlighted.
- **Scene:** four fault cards with the three answers; the UNREACHABLE card showing IK-seam surface but Understand owner.
- **Labels:** "What failed", "Where", "Who owns the fix", "localise before recover".
- **Form:** SVG.
