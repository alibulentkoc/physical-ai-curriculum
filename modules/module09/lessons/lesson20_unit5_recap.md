...
unit: 05
lesson: 5.4
title: "Unit 5 Recap: Execute → Track"
core_idea: "Unit 5 added the stage that judges. Execute produces motion; Track reads that motion against explicit success criteria and returns a verdict with a localising reason; system monitoring collects the health signals every layer already emits into one dashboard; and the case study turned those signals into a plain-language reading. The forward path now has eyes. This recap consolidates Execute → Track and sets up Unit 6, which turns the reading into automatic failure detection."
estimated_time: "30 min"
difficulty: "Intermediate"
prerequisites:
  - "5.1 — Tracking error and success criteria"
  - "5.2 — System monitoring"
  - "5.3 — Reading telemetry"
learning_objectives:
  - "Reproduce the Execute → Track flow: motion, verdict, telemetry, reading."
  - "State the health-vs-success distinction and the ownership of the judgement."
  - "Identify what Unit 6 adds: a failure taxonomy and automatic detection."
tags:
  - physical-ai
  - robotics
  - systems-integration
...
`[Visual: the Execute → Track segment — Execute (motion) feeding Track (verdict) and a system-monitor dashboard (telemetry), with a "reading" speech bubble combining them; a greyed "Unit 6: automatic detection" box downstream.]`

**Diagram Specification**
- **Objective:** one image consolidating Execute → Track: motion, verdict, telemetry, reading.
- **Scene:** Execute → Track (verdict) + monitor (dashboard) → reading; Unit 6 greyed as next.
- **Labels:** "motion", "verdict + reason", "telemetry dashboard", "reading", "Unit 6: detect".
- **Form:** SVG.
