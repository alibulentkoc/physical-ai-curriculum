...
unit: 01
lesson: 1.4
title: "Unit 1 Recap: The System View"
core_idea: "Consolidate the integration mindset before opening the first real seam. Unit 1 established three things: integration is its own discipline (bugs live in the seams), the six-stage spine organises the whole module, and a trace is how we read cooperation between layers. This recap stitches them into one working mental model and one runnable check."
estimated_time: "30 min"
difficulty: "Intermediate"
prerequisites:
  - "1.1 — Why integration is hard"
  - "1.2 — The six-stage workflow"
  - "1.3 — System walkthrough"
learning_objectives:
  - "Restate the integration mindset: system correctness vs. component correctness."
  - "Reproduce the six-stage spine with owner / input / output from memory."
  - "Run and read a minimal end-to-end trace as a single consolidated check."
tags:
  - physical-ai
  - robotics
  - systems-integration
...
`[Visual: a single "system view" summary card — the six-stage ring in the centre, the relay-race seam icon on one side, the boarding-pass trace on the other, tying the three Unit 1 ideas into one image.]`

**Diagram Specification**
- **Objective:** one image that recalls all three Unit 1 ideas together.
- **Scene:** central six-stage loop; left, the seam/relay motif; right, the stamped trace.
- **Labels:** "seams", "spine", "trace", and the six stage names.
- **Form:** SVG.
