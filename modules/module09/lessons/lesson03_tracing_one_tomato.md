...
unit: 01
lesson: 1.3
title: "System Walkthrough: Tracing One Tomato Through All Six Stages"
core_idea: "We follow a single tomato from photons to picked, stopping at every stage to read the blackboard: what each stage received, what it decided, what it wrote, and who owned that decision. This is the spine made concrete on the real layers — a guided tour that turns the abstract workflow into a story you can run."
estimated_time: "45 min"
difficulty: "Intermediate"
prerequisites:
  - "1.2 — The six-stage workflow and the registry"
learning_objectives:
  - "Follow one target through all six stages and name the blackboard field each stage writes."
  - "Identify, at each stage, the input source and the owning subsystem."
  - "Read a system trace as evidence of correct cooperation between layers."
tags:
  - physical-ai
  - robotics
  - systems-integration
...
`[Visual: a vertical "boarding pass" for tomato F3 — six stamped rows, one per stage, each row showing the input value, the decision, the output value written to the blackboard, and the owning module stamp.]`

**Diagram Specification**
- **Objective:** make the trace tangible as a single object that accumulates stamps.
- **Scene:** a ticket/passport for F3; each of the six stages adds a stamp with in→out values and an owner.
- **Labels:** stage name, input snippet, output snippet, owner, per row.
- **Form:** SVG.
