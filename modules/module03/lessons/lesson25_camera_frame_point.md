...
unit: 07
lesson: 7.1
title: The Camera-Frame 3D Point
core_idea: "Back-projection gives a point in the camera frame. To act on it, the robot must know it is expressed in the camera's coordinate system — not the world's."
estimated_time: 40
difficulty: Core
prerequisites: [6.4]
learning_objectives:
  - State clearly which frame a back-projected point lives in.
  - Explain why the camera frame is not directly actionable.
  - Set up the transform problem solved in this unit.
tags:
  - physical-ai
  - perception
  - frames
...
`[Visual: the same fruit point shown with a camera-frame coordinate triad and a world-frame triad, with a transform arrow T(world←cam) between them]`

**Diagram Specification**
- **Objective:** show one point, two frames, one transform.
- **Scene:** a tomato; a camera frame triad (axes) near a camera with the point labeled P_c=(0.06,-0.03,0.3); a world frame triad at the robot base; an arrow "T(world←cam)" mapping P_c to P_w.
- **Labels:** "same point," "camera frame," "world frame," "needs T(world←cam)."
- **Form:** SVG (faux-3D).
