...
unit: 05
lesson: 5.1
title: Why Straight Lines Bend
core_idea: "Real lenses deviate from the ideal pinhole: straight lines in the world can appear curved in the image. This is lens distortion, and it must be modeled to project and back-project accurately."
estimated_time: 40
difficulty: Core
prerequisites: [4.4]
learning_objectives:
  - Recognize lens distortion as a deviation from the ideal pinhole model.
  - Identify barrel and pincushion distortion visually.
  - Explain why distortion matters for accurate perception.
tags:
  - physical-ai
  - perception
  - distortion
...
`[Visual: a square grid shown three ways — undistorted (straight), barrel (bowed outward), pincushion (pinched inward) — with the center nearly unchanged and edges most affected]`

**Diagram Specification**
- **Objective:** show distortion as bending that grows with radius.
- **Scene:** three small square grids side by side: "ideal (pinhole)" with straight lines; "barrel" with lines bowing outward; "pincushion" with lines pinching inward; an arrow noting "center ≈ unchanged, edges bend most."
- **Labels:** "ideal," "barrel (k>0)," "pincushion (k<0)," "distortion grows with radius r."
- **Form:** SVG.
