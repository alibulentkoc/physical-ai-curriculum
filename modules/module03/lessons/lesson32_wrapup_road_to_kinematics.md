...
core_idea: "Module 3 turned pixels into verified world positions. The open question — where the arm's pose comes from — launches Module 4: forward kinematics."
estimated_time: 25
difficulty: Review
prerequisites: [8.1, 8.2, 8.3]
learning_objectives:
  - Consolidate the entire Module 3 perception pipeline.
  - Articulate what perception does and does not provide.
  - Motivate Module 4 (forward kinematics).
tags:
  - physical-ai
  - perception
  - capstone
...
`[Visual: Module 3 perception pipeline feeding a world target, with a dashed arrow to a Module 4 box labeled "forward kinematics supplies T(world←arm)"]`

**Diagram Specification**
- **Objective:** close Module 3 and motivate Module 4.
- **Scene:** the compact pixel→world pipeline ending at a tomato world position; a dashed arrow from "T(world←arm)?" to a Module 4 box "Forward Kinematics (DH parameters)"; robot arm with joint angles hinted.
